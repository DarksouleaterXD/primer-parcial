...
export const testEnvironment = {
  ...
  POSTGRES_PORT: process.env.POSTGRES_PORT?.trim() || "5432",
  POSTGRES_DB: process.env.POSTGRES_TEST_DB?.trim() || "primer_parcial_test",
  POSTGRES_USER: process.env.POSTGRES_USER?.trim() || "primer_parcial_local",
  POSTGRES_PASSWORD: process.env.POSTGRES_PASSWORD || "local-example-only",
