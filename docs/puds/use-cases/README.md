...
PlanificaciÃ³n definitiva: **12 casos de uso en 3 ciclos**, con uno a tres incrementos por CU. Define cobertura futura; el avance real estÃ¡ en [STATUS](../../STATUS.md). CU-0 y CU-1 estÃ¡n terminados; CU-2.1 estÃ¡ planificado y su implementaciÃ³n requiere aprobaciÃ³n explÃ­cita.
...
2. **Comandos e historial:** contratos desacoplados del transporte, `UmlCommandBus`/executor para clases, atributos, enums, relaciones, multiplicidades, herencia, movimiento y metadatos. Intenciones atÃ³micas identificables; historial configurable de 100 operaciones, estrategia snapshot o compensaciÃ³n y costo documentados.
