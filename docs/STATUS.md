...
- CU-2 — Modelar diagramas UML manualmente: **en implementación** porque CU-2.2 y CU-2.3 siguen pendientes.
...
- Rama de CU-2.1 confirmada: `feature/cu-2-1-modelo-validacion`.
...
- CU-2.2 y CU-2.3 no deben iniciarse antes del cierre formal de CU-2.1.
...
|---|---|---|
| 1. Editor UML con proyectos privados | CU-0 y CU-1 archivados; CU-2.1 implementado, verify sin CRITICAL y verificación de comportamiento completada; CU-2.2, CU-2.3 y CU-3 pendientes | Cuenta, editor validado con Undo/Redo y proyectos privados persistentes |
